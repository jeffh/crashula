...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CrashReport.count'
        db.add_column(u'crashes_crashreport', 'count',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'crashes_crash', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='crashes', to=orm['auth.User'])),
        ...
        # Deleting field 'CrashReport.count'
        db.delete_column(u'crashes_crashreport', 'count')
